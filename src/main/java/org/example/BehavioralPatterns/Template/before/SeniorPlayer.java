...
public class SeniorPlayer implements Player {
    private final GuessNumberGame guessNumberGame;

    public SeniorPlayer(GuessNumberGame guessNumberGame) {
    ...
    public PlayerInfo buildPlayer(String name) {
        ...
        playerInfo.setMaxGuessTimes(3);
        playerInfo.setType(PlayerType.Senior);
        return playerInfo;
    }
