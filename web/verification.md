...
「隨著需求，逐步長出設計」改以閱讀統計報表貫穿六站，每站包含需求、問題、調整、前後比較與判斷重點，圖中角色同步更新。Chromium 已驗證六站內容與圖文切換、上一／下一個需求、首尾停用狀態及 390px 無頁面溢出；JavaScript 語法檢查通過。畫面：[桌面敘事](evidence/evolution-story-desktop.png)、[手機敘事](evidence/evolution-story-mobile.png)。
