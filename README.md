# 前言
&emsp;&emsp;本篇內容僅以個人觀點表達看法，目標希望能以一個快速客觀的角度審視自己的程式，
內容不見得能適用各個情境，但是可做為讀者思考的起點。
...
變得湊綜複雜，可維護性降低，間接造成對新人不友善、過度依賴資深員工，現實中"大泥球"仍然是常見的軟體設計，
為了避免大泥球即早出現，使用Design Pattern是一個很好出發點，主要是降低認知複雜度、抽象化細節、可重複利用程式代碼，
